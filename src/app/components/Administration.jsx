  ...
  return (
    <section className="py-16 bg-[var(--white-color)] text-[var(--gray-color)]">
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 px-6">
        {/* Card 1 */}
        <div className="text-sm text-gray-500 w-full sm:w-80 divide-y divide-gray-300 border border-gray-200 rounded-xl bg-[var(--white-color)] shadow-md hover:shadow-lg transition-all duration-300">
          <div className="flex flex-col items-center py-8">
            ...
            <p className="text-gray-500">Need Simple Title</p>
